...
public class CodeGeneratorTest {
  ...
  @Test
  public void basicArrayInitialize() throws Exception {
    String s = buildString
            ("fun void main() {",
                    "arr x = {1}",
                    "print(itos(x[0]))",
  ...
  @Test
  public void basicArrayUpdateVal() throws Exception {
    String s = buildString
            ("fun void main() {",
                    "arr x = {1}",
                    "x[0] = 2",
  ...
  @Test
  public void basicEmptyArr() throws Exception {
    String s = buildString
            ("fun void main() {",
                    "arr int x = {}",
                    "}");
  ...
  @Test
  public void basicAddValArray() throws Exception {
    String s = buildString
            ("fun void main() {",
                    "arr int x = {1}",
                    "add(x,2)",
