...
public class StaticCheckerTest {
  ...
  public void mismatchedArgTypeInRecursiveFunctionCall() throws Exception {
    String s = buildString
      ("fun int f1(char a, int c, double d, int b) {",
       "  f1('0', 1, 2.0, true)",
       "}",
       "fun void main() {}"
       );
  ...
  @Test
  public void goodArray() throws Exception {
    String s = buildString
            ("fun void main() {",
                    "  arr x = {1}",
                    "  var z = x[0]",
  ...
  @Test
  public void goodArray2() throws Exception {
    String s = buildString
            ("fun void main() {",
                    "  arr x = {1,2,3}",
                    "  x[0] = 12",
  ...
  @Test
  public void goodArrayNodePath() throws Exception {
    String s = buildString
            ("type T {",
                    "  var x = 0",
                    "  var T next = nil",
  ...
  @Test
  public void goodNodeArrayList() throws Exception {
    String s = buildString
            ("type T {",
                    "  arr x = {'a','b'}",
                    "}",
  ...
  @Test
  public void wrongTypeArrAssign() throws Exception {
    String s = buildString
            ("fun void main() {",
                    "  arr x = {1,2}",
                    "  x[1] = 'a'",
  ...
  @Test
  public void invalidInitalizationArray() throws Exception {
    String s = buildString
            ("fun void main() {",
                    "  arr x = {1,2, 'a'}",
                    "}"
