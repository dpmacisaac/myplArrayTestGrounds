...
public class Lexer {
  ...
  public Token nextToken() throws MyPLException {
    ...
    while(true){
      ...
      if (isSymbol(currChar, '(')) {
        ...
        return new Token(TokenType.LBRACK, "[", tokenLine, tokenColumn);
      }
      else if (isSymbol(currChar, ']')) {
        return new Token(TokenType.RBRACK, "]", tokenLine, tokenColumn);
      }
      else if (isSymbol(currChar, '{')) {
  ...
  private void checkWord() throws MyPLException{
    if(isLetter(currChar)){
      ...
      else if(lexeme.toString().equals("arr")){
        returnToken = new Token(TokenType.ARR, "arr", tokenLine, tokenColumn);
      }
      else {
